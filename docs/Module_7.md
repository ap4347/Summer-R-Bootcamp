...
#>     year month   day dep_time sched_dep_time dep_delay
#>    <int> <int> <int>    <int>          <int>     <int>
#>  1  2013     3    13      857            900        -3
#>  2  2013     1    27       NA           1455        NA
#>  3  2013    10     1     1852           1900        -8
#>  4  2013     7     6      623            630        -7
#>  5  2013    11    19     2013           2000        13
#>  6  2013     1    31     2159           2005       114
#>  7  2013     4     2     1155           1200        -5
#>  8  2013    11    12     1600           1600         0
#>  9  2013     8    27      758            805        -7
#> 10  2013     7    29     2158           2140        18
#> # ℹ 13 more variables: arr_time <int>,
#> #   sched_arr_time <int>, arr_delay <int>, carrier <chr>,
#> #   flight <int>, tailnum <chr>, origin <chr>, dest <chr>,
#> #   air_time <int>, distance <int>, hour <int>,
...
#>     year month   day dep_time sched_dep_time dep_delay
#>    <int> <int> <int>    <int>          <int>     <int>
#>  1  2013     1     7      454            500        -6
#>  2  2013     3    26      759            800        -1
#>  3  2013     8    11     1720           1722        -2
#>  4  2013     1    14      655            700        -5
#>  5  2013     2     4     1613           1615        -2
#>  6  2013     8    12      630            630         0
#>  7  2013     6    18     2159           2030        89
#>  8  2013     9     9      623            630        -7
#>  9  2013     6    29     1346           1330        16
#> 10  2013     9     7     1208           1159         9
#> # ℹ 326 more rows
#> # ℹ 13 more variables: arr_time <int>,
#> #   sched_arr_time <int>, arr_delay <int>, carrier <chr>,
#> #   flight <int>, tailnum <chr>, origin <chr>, dest <chr>,
