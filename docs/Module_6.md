...
#>     year month   day dep_time sched_dep_time dep_delay
#>    <int> <int> <int>    <int>          <int>     <int>
#>  1  2013     6    16     1550           1503        47
#>  2  2013     5     4      652            655        -3
#>  3  2013     6    19     1521           1525        -4
#>  4  2013    11     1     1502           1410        52
#>  5  2013     8    19      825            830        -5
#>  6  2013    12     4      703            710        -7
#>  7  2013    10    18      812            815        -3
#>  8  2013    11     3      827            830        -3
#>  9  2013     3     7     2050           2055        -5
#> 10  2013     8     2      657            700        -3
#> # ℹ 13 more variables: arr_time <int>,
#> #   sched_arr_time <int>, arr_delay <int>, carrier <chr>,
#> #   flight <int>, tailnum <chr>, origin <chr>, dest <chr>,
#> #   air_time <int>, distance <int>, hour <int>,
...
#>     year month   day dep_time sched_dep_time dep_delay
#>    <int> <int> <int>    <int>          <int>     <int>
#>  1  2013     9    10      807            815        -8
#>  2  2013    12     6      819            825        -6
#>  3  2013    10    14      557            600        -3
#>  4  2013     7    16     1031           1030         1
#>  5  2013     5    31      829            830        -1
#>  6  2013     7    20     1840           1705        95
#>  7  2013     3    21     1646           1650        -4
#>  8  2013     5    13     1545           1550        -5
#>  9  2013    10    18      812            810         2
#> 10  2013     3    11     1349           1400       -11
#> # ℹ 326 more rows
#> # ℹ 13 more variables: arr_time <int>,
#> #   sched_arr_time <int>, arr_delay <int>, carrier <chr>,
#> #   flight <int>, tailnum <chr>, origin <chr>, dest <chr>,
