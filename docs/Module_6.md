...
#>     year month   day dep_time sched_dep_time dep_delay
#>    <int> <int> <int>    <int>          <int>     <int>
#>  1  2013     2    25     2004           2010        -6
#>  2  2013     4    17     2127           1659       268
#>  3  2013     6    18     2122           1836       166
#>  4  2013     9    17     1637           1642        -5
#>  5  2013    11    16     1833           1615       138
#>  6  2013     2    19     2101           1940        81
#>  7  2013     7    31     1458           1459        -1
#>  8  2013     3    29      655            700        -5
#>  9  2013     3     8     1143           1110        33
#> 10  2013     6    22     1540           1545        -5
#> # ℹ 13 more variables: arr_time <int>,
#> #   sched_arr_time <int>, arr_delay <int>, carrier <chr>,
#> #   flight <int>, tailnum <chr>, origin <chr>, dest <chr>,
#> #   air_time <int>, distance <int>, hour <int>,
...
#>     year month   day dep_time sched_dep_time dep_delay
#>    <int> <int> <int>    <int>          <int>     <int>
#>  1  2013     1     6     1534           1515        19
#>  2  2013     9    30     1759           1755         4
#>  3  2013    10     9     1354           1359        -5
#>  4  2013     3     9     1615           1608         7
#>  5  2013     5    12     1941           1900        41
#>  6  2013    10    25      605            610        -5
#>  7  2013     6    15      822            823        -1
#>  8  2013     1     2     2115           2059        16
#>  9  2013     5    24     1311           1300        11
#> 10  2013    11     2      556            600        -4
#> # ℹ 326 more rows
#> # ℹ 13 more variables: arr_time <int>,
#> #   sched_arr_time <int>, arr_delay <int>, carrier <chr>,
#> #   flight <int>, tailnum <chr>, origin <chr>, dest <chr>,
