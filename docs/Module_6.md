...
#>     year month   day dep_time sched_dep_time dep_delay
#>    <int> <int> <int>    <int>          <int>     <int>
#>  1  2013     6    26     1155           1154         1
#>  2  2013     6    21      651            700        -9
#>  3  2013    11    16     1627           1530        57
#>  4  2013    10     9      654            700        -6
#>  5  2013     1    12       NA            629        NA
#>  6  2013     8    17     2025           2036       -11
#>  7  2013     1    25     1341           1345        -4
#>  8  2013    11     2      644            645        -1
#>  9  2013    10    30      750            755        -5
#> 10  2013    10    20      826            830        -4
#> # ℹ 13 more variables: arr_time <int>,
#> #   sched_arr_time <int>, arr_delay <int>, carrier <chr>,
#> #   flight <int>, tailnum <chr>, origin <chr>, dest <chr>,
#> #   air_time <int>, distance <int>, hour <int>,
...
#>     year month   day dep_time sched_dep_time dep_delay
#>    <int> <int> <int>    <int>          <int>     <int>
#>  1  2013    12    10     1219           1220        -1
#>  2  2013    12    12     1510           1450        20
#>  3  2013     4     8      908            914        -6
#>  4  2013     3    19      601            600         1
#>  5  2013    10     8      849            837        12
#>  6  2013    10    26      724            725        -1
#>  7  2013     8    30     1448           1450        -2
#>  8  2013     5    12     1750           1800       -10
#>  9  2013    11    30     1639           1645        -6
#> 10  2013    12    17     1616           1605        11
#> # ℹ 326 more rows
#> # ℹ 13 more variables: arr_time <int>,
#> #   sched_arr_time <int>, arr_delay <int>, carrier <chr>,
#> #   flight <int>, tailnum <chr>, origin <chr>, dest <chr>,
